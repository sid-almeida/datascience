...
if choice == "Previsão":
    ...
    # st.write(curso)
    # st.write(turno)
    # st.write(qualificacao_previa)
    # st.write(nacionalidade)
    # st.write(necessidades_especiais)
    # st.write(mensalidade_em_dia)
    # st.write(sexo)
    # st.write(bolsista)
    # st.write(aprovacoes)
    # st.write(aproveitamentos)
    # st.write(matriculas)
    # st.write(media)
    # st.write(indice_desemprego)
    # st.write(indice_inflacao)
    # st.write(PIB)
